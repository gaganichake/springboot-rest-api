...
public class Vehicle {
    ...
    private String json; // Store additional fields in JSON format
    ...
    private Map<String, Object> map; // Store additional fields in Map object as String

    // Option 3: Use a JsonNode to store dynamic fields.
    // You can also use a JsonNode to store dynamic fields.
    @Convert(converter = JsonConverter.class)
    private JsonNode jsonNode; // Store additional fields in JsonNode object  as String
}
